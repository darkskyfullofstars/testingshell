...
# Change Windows Update to disable driver offerings, only install Security Updates
Function FTTRegistryTweaks {
	...
	Write-Output "Operation Complete: FTT Registry Tweaks"
}

# No registry tweaks for Windows Update 
Function NoFTTRegistryTweaks{
	Write-Output "No Registry Tweaks"
}

# Change Default Apps using MyDefaultAppAssociations.XML file
...
# Stop Edge takeover of PDF files
...
# Do not Debloat All Microsoft Apps
